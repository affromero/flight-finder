...
import { addBrowserSession, setupBrowserOwner } from './access-browser-test.mjs';
...
const ownerSession = await setupBrowserOwner({ origin: server, name: 'hotel-browser-owner', password: 'hotel-browser-owner-test-password' });
const passed = [];
